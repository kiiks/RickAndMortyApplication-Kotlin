...
class CharacterViewAdapter constructor(context: Context?, characterList: List<CharacterResult?>): RecyclerView.Adapter<CharacterViewAdapter.MyVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CharacterViewAdapter.MyVH
    {
    ...
    override fun onBindViewHolder(holder: CharacterViewAdapter.MyVH, position: Int)
    {
